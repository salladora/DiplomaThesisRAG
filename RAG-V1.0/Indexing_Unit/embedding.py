...
def list_vectors_with_metadata(vectors: list, chunks: list, doc_id: int) -> list:
    """ Creates a list of vector embeddings and their respective metadata.

    For each chunk a dictionary is created containing the index-id, the vector embedding and the plaintext chunk including the document name.
